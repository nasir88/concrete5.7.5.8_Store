...
$myURLThemeDashboard = $URLTheme->myURLThemeDashboard();
...
<head>
    <link rel="stylesheet" type="text/css" href="<?php echo DIR_REL?>/concrete/themes/dashboard/main.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo DIR_REL?>/application/themes/dashboard/nsr_main.css" />
<?php
...
if($u->isSuperUser()) {
	...
	header("Location: " . Core::getApplicationURL());
	exit();
}
?>
    ...
    <div class="ccm-mobile-menu-overlay ccm-mobile-menu-overlay-dashboard hidden-md hidden-lg">
        <div class="ccm-mobile-menu-main">
            <ul class="ccm-mobile-menu-entries">
                <li><i class="fa fa-sliders mobile-leading-icon"></i><a href="<?php echo URL::to('/'.$myURLTheme)?>"><?php echo t('Dashboard') ?><i class="fa fa-caret-down"></i></a>
                    <ul class="list-unstyled">
                        <li class="last-li"><a href="<?php echo View::url('/'.$myURLTheme.'/sitemap') ?>"><?php echo t('Sitemap'); ?></a></li>
                        <li class="last-li"><a href="<?php echo View::url('/'.$myURLTheme.'/files') ?>"><?php echo t('Files'); ?></a></li>
                        <li class="last-li"><a href="<?php echo View::url('/'.$myURLTheme.'/users') ?>"><?php echo t('Members'); ?></a></li>
                        <li class="last-li"><a href="<?php echo View::url('/'.$myURLTheme.'/reports') ?>"><?php echo t('Reports'); ?></a></li>
                        <li class="last-li"><a href="<?php echo View::url('/'.$myURLTheme.'/pages') ?>"><?php echo t('Pages & Themes'); ?></a></li>
                        <li class="last-li"><a href="<?php echo View::url('/'.$myURLTheme.'/workflow') ?>"><?php echo t('Workflow'); ?></a></li>
                        <li class="last-li"><a href="<?php echo View::url('/'.$myURLTheme.'/blocks/stacks') ?>"><?php echo t('Stacks & Blocks'); ?></a></li>
                        <li class="last-li"><a href="<?php echo View::url('/'.$myURLTheme.'/extend') ?>"><?php echo t('Extend concrete5'); ?></a></li>
                        <li class="last-li"><a href="<?php echo View::url('/'.$myURLTheme.'/system') ?>"><?php echo t('System & Settings'); ?></a></li>
                    </ul>
                </li>
                <li>
...
<div id="ccm-toolbar" class="<?php echo $show_titles ? 'titles' : '' ?> <?php echo $large_font ? 'large-font' : '' ?>">
    <ul>
        ...
        <!--<li class="pull-right hidden-xs hidden-sm">
            <a href="<?php //echo URL::to('/'.$myURLTheme)?>"
		...
		<li class="pull-right hidden-xs hidden-sm">
            <a href="<?php echo URL::to('/'.$myURLThemeDashboard)?>" data-launch-panel="dashboard">
                <i class="fa fa-sliders"></i>
                <span class="ccm-toolbar-accessibility-title ccm-toolbar-accessibility-title-site-settings">
                    <?php echo tc('toolbar', 'Dashboard') ?>
                </span>
		...
		<li class="ccm-toolbar-account pull-right">
            <a href="<?php echo URL::to('/'.$myURLThemeAdminLte) ?>">
                <i class="fa fa-puzzle-piece"></i>
                <span class="ccm-toolbar-accessibility-title ccm-toolbar-accessibility-title-return">
                    <?php echo tc('toolbar', 'Return to Dashboard Administrator') ?>
                </span>
            </a>
        </li>
        <!--<li class="pull-right hidden-xs hidden-sm">
