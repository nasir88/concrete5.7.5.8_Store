...
if (isset($cp) && $canViewToolbar && (!$dh->inDashboard())) {
	...
	?>
		<div id="ccm-page-controls-wrapper" class="ccm-ui" style="display:none">
	<?php } else { ?>
		<div id="ccm-page-controls-wrapper" class="ccm-ui">
	<?php 
		}
    ...
    <div class="ccm-mobile-menu-overlay">
        <div class="ccm-mobile-menu-main">
            <ul class="ccm-mobile-menu-entries">
				...
				<li class="ccm-toolbar-page-edit"><i class="fa fa-sliders mobile-leading-icon"></i><a data-toolbar-action="check-out"
						href="<?php if($u->isSuperUser()) { 
								echo URL::to('/'.$myURLThemeDashboard); 
							  }else{
								echo URL::to('/'.$myURLThemeAdminLte);
							  }
                ...
                <!--<li class="parent-ul"><i class="fa fa-sliders mobile-leading-icon"></i><a
                    ...
                    <ul class="list-unstyled">
                        <li class="last-li"><a href="<?php //echo URL::to('/dashboard/sitemap') ?>"><?php //echo t('Sitemap'); ?></a></li>
                        <li class="last-li"><a href="<?php //echo URL::to('/dashboard/files') ?>"><?php //echo t('Files'); ?></a></li>
                        <li class="last-li"><a href="<?php //echo URL::to('/dashboard/users') ?>"><?php //echo t('Members'); ?></a></li>
                        <li class="last-li"><a href="<?php //echo URL::to('/dashboard/reports') ?>"><?php //echo t('Reports'); ?></a></li>
                        <li class="last-li"><a href="<?php //echo URL::to('/dashboard/pages') ?>"><?php //echo t('Pages & Themes'); ?></a></li>
                        <li class="last-li"><a href="<?php //echo URL::to('/dashboard/workflow') ?>"><?php //echo t('Workflow'); ?></a></li>
                        <li class="last-li"><a href="<?php //echo URL::to('/dashboard/blocks/stacks') ?>"><?php //echo t('Stacks & Blocks'); ?></a></li>
                        <li class="last-li"><a href="<?php //echo URL::to('/dashboard/extend') ?>"><?php //echo t('Extend concrete5'); ?></a></li>
                        <li class="last-li"><a href="<?php //echo URL::to('/dashboard/system') ?>"><?php //echo t('System & Settings'); ?></a></li>
                    </ul>
                </li>-->
                <?php } ?>
                <li>
