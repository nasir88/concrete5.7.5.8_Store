...
?><form action="<?php echo $view->url($resultTargetURL)?>" method="get" class="sidebar-form">
    ...
    ?><input name="query" type="text" class="form-control" placeholder="Search..." value="<?php echo htmlentities($query, ENT_COMPAT, APP_CHARSET)?>" class="ccm-search-block-text" /><?php
