...
<form action="<?php echo $view->url($resultTargetURL)?>" method="get">
	<div class="input-group">
	
		<input name="query" type="text" class="form-control" placeholder="<?php echo t("Search") ?>..." value="<?php echo htmlentities($query, ENT_COMPAT, APP_CHARSET)?>" />
