 ...
 */
class DateRestrictionPromotionRule extends \Concrete\Package\VividStore\Src\VividStore\Promotion\PromotionRules\DateRestrictionPromotionRule implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DateRestrictionPromotionRule $proxy) {
