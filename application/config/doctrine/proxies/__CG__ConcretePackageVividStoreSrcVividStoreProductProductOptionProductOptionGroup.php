 ...
 */
class ProductOptionGroup extends \Concrete\Package\VividStore\Src\VividStore\Product\ProductOption\ProductOptionGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'pogID', 'pID', 'pogName', 'pogSort');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductOptionGroup $proxy) {
    ...
    public function update($product, $name, $sort)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'update', array($product, $name, $sort));

        return parent::update($product, $name, $sort);
    }
