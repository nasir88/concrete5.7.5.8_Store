 ...
 */
class QtyInCartPromotionRule extends \Concrete\Package\VividStore\Src\VividStore\Promotion\PromotionRules\QtyInCartPromotionRule implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (QtyInCartPromotionRule $proxy) {
