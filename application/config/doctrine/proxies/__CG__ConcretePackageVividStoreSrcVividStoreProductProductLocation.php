 ...
 */
class ProductLocation extends \Concrete\Package\VividStore\Src\VividStore\Product\ProductLocation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'pID', 'cID');
        }
