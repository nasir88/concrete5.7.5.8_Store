 ...
 */
class ProductExistsPromotionRule extends \Concrete\Package\VividStore\Src\VividStore\Promotion\PromotionRules\ProductExistsPromotionRule implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductExistsPromotionRule $proxy) {
