 ...
 */
class ProductFile extends \Concrete\Package\VividStore\Src\VividStore\Product\ProductFile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'dfID', 'pID', 'dffID');
        }
