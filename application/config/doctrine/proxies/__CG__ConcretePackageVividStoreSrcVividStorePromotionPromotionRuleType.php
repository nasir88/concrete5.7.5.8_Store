 ...
 */
class PromotionRuleType extends \Concrete\Package\VividStore\Src\VividStore\Promotion\PromotionRuleType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'handle', 'name', 'pkgID', '' . "\0" . 'Concrete\\Package\\VividStore\\Src\\VividStore\\Promotion\\PromotionRuleType' . "\0" . 'controller');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PromotionRuleType $proxy) {
