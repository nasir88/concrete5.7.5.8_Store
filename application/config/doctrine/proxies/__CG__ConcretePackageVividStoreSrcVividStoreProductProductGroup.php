 ...
 */
class ProductGroup extends \Concrete\Package\VividStore\Src\VividStore\Product\ProductGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'pgID', 'pID', 'gID');
        }
