 ...
 */
class FreeProductPromotionReward extends \Concrete\Package\VividStore\Src\VividStore\Promotion\PromotionRewards\FreeProductPromotionReward implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Concrete\\Package\\VividStore\\Src\\VividStore\\Promotion\\PromotionRewards\\FreeProductPromotionReward' . "\0" . 'product', 'id', 'promotionID', 'view', 'viewPath', 'theme', 'controllerActionPath', 'themeViewTemplate', 'helpers', 'sets', 'action', 'request', 'parameters', 'app');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FreeProductPromotionReward $proxy) {
