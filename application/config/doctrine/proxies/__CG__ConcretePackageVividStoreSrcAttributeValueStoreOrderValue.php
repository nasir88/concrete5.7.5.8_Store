 ...
 */
class StoreOrderValue extends \Concrete\Package\VividStore\Src\Attribute\Value\StoreOrderValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'oID', 'akID', 'avID', 'attributeType', 'attributeKey', 'error');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StoreOrderValue $proxy) {
