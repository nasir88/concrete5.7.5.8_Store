 ...
 */
class StoreProductKey extends \Concrete\Package\VividStore\Src\Attribute\Key\StoreProductKey implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StoreProductKey $proxy) {
    ...
    public function getAttributes($pID, $method = 'getValue')
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAttributes', array($pID, $method));

        return parent::getAttributes($pID, $method);
    }
