 ...
 */
class UserGroupPromotionRule extends \Concrete\Package\VividStore\Src\VividStore\Promotion\PromotionRules\UserGroupPromotionRule implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserGroupPromotionRule $proxy) {
