...
namespace Application\Controller\SinglePage\Dashboard\System\Registration;
	...
	public function update_profiles() {
		...
		if ($this->isPost()) {
			...
			if($this->post('public_profiles')) {
			    $this->redirect('/'.$myURLTheme.'/system/registration/profiles/profiles_enabled');
            } else {
                $this->redirect('/'.$myURLTheme.'/system/registration/profiles/profiles_disabled');
            }
		}
	}
