	...
	function update_modern_thumbnail() {
		if($this->token->validate('update_modern_thumbnail')) {
			...
			if ($myURLTheme === $myURLThemeAdminLte) {
				$this->redirect('/'.$myURLTheme.'/system/icons/', $result);
			}else{
				$this->redirect('/'.$myURLTheme.'/system/basics/icons/', $result);
			}
	...
	function update_iphone_thumbnail(){
		if ($this->token->validate("update_iphone_thumbnail")) {
			...
			if($faviconFID){
				...
				if ($myURLTheme === $myURLThemeAdminLte) {
					$this->redirect('/'.$myURLTheme.'/system/icons/', 'iphone_icon_saved');
				}else{
					$this->redirect('/'.$myURLTheme.'/system/basics/icons/', 'iphone_icon_saved');
				}
				...
				if ($myURLTheme === $myURLThemeAdminLte) {
					$this->redirect('/'.$myURLTheme.'/system/icons/', 'iphone_icon_removed');
				}else{
					$this->redirect('/'.$myURLTheme.'/system/basics/icons/', 'iphone_icon_removed');
				}
	...
	function update_favicon(){
		if ($this->token->validate("update_favicon")) {
            ...
            if($faviconFID) {
				...
				if ($myURLTheme === $myURLThemeAdminLte) {
					$this->redirect('/'.$myURLTheme.'/system/icons/', 'favicon_saved');
				}else{
					$this->redirect('/'.$myURLTheme.'/system/basics/icons/', 'iphone_icon_saved');
				}
				...
				if ($myURLTheme === $myURLThemeAdminLte) {
					$this->redirect('/'.$myURLTheme.'/system/icons/', 'favicon_removed');
				}else{
					$this->redirect('/'.$myURLTheme.'/system/basics/icons/', 'favicon_removed');
				}
