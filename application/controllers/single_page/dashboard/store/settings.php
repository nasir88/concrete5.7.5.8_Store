    ...
    public function save()
    {
        ...
        if ($this->isPost()) {
            ...
            if (!$errors->has()) {
                ...
                Config::save('vividstore.fromCompanyName', $args['fromCompanyName']);
                Config::save('vividstore.fromCompanyRegistrationNo', $args['fromCompanyRegistrationNo']);
                Config::save('vividstore.fromCompanyFirstAddress', $args['fromCompanyFirstAddress']);
                Config::save('vividstore.fromCompanySecondAddress', $args['fromCompanySecondAddress']);
                Config::save('vividstore.fromCompanyCountry', $args['fromCompanyCountry']);
                Config::save('vividstore.fromCompanyCity', $args['fromCompanyCity']);
                Config::save('vividstore.fromCompanyState', $args['fromCompanyState']);
                Config::save('vividstore.fromCompanyPostal', $args['fromCompanyPostal']);
                Config::save('vividstore.paymentTimingDays', $args['paymentTimingDays']);
                Config::save('vividstore.paymentTimingHours', $args['paymentTimingHours']);
                Config::save('vividstore.paymentTimingMinutes', $args['paymentTimingMinutes']);
                Config::save('vividstore.paymentTimingSeconds', $args['paymentTimingSeconds']);
                ...
                $this->redirect('/'.$myURLTheme.'/store/settings/success');
