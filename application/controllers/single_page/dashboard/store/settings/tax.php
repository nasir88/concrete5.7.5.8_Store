...
class Tax extends DashboardPageController
{
    ...
    public function delete($trID)
    {
        ...
        $this->redirect('/'.$myURLTheme.'/store/settings/tax/removed');
    }
    ...
    public function add_rate()
    {
        ...
        if (!$errors->has()) {
            if($this->post('taxRateID')){
				...
				$URLTheme = new URLTheme();
				$myURLTheme = $URLTheme->myURLTheme();
				$this->redirect('/'.$myURLTheme.'/store/settings/tax/updated');
            } else {
				...
				$URLTheme = new URLTheme();
				$myURLTheme = $URLTheme->myURLTheme();
				$this->redirect('/'.$myURLTheme.'/store/settings/tax/success');
            }
        } else {
            if($this->post('taxRateID')){
    ...
    public function save_class()
    {
        ...
        if (!$errors->has()) {
            if($this->post('taxClassID')){
				...
				$URLTheme = new URLTheme();
				$myURLTheme = $URLTheme->myURLTheme();
				$this->redirect('/'.$myURLTheme.'/store/settings/tax/class_updated');
            } else {
                //add.
				...
				$URLTheme = new URLTheme();
				$myURLTheme = $URLTheme->myURLTheme();
				$this->redirect('/'.$myURLTheme.'/store/settings/tax/class_added');
            }
        }
    }
    ...
    public function delete_class($tcID)
    {
		...
		$URLTheme = new URLTheme();
		$myURLTheme = $URLTheme->myURLTheme();
		$this->redirect('/'.$myURLTheme.'/store/settings/tax/class_deleted');
