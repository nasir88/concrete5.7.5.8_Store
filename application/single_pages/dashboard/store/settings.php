<?php defined('C5_EXECUTE') or die("Access Denied."); ?>
	    ...
	    <div class="ccm-dashboard-header-buttons marginBot10">
            <a href="<?php echo View::url('/'.$_SESSION['myURLTheme'].'/store/settings/shipping')?>" class="btn bg-olive mobile-width"><i class="fa fa-gift"></i> &nbsp; <?php echo t("Shipping Methods")?></a>
            <a href="<?php echo View::url('/'.$_SESSION['myURLTheme'].'/store/settings/tax')?>" class="btn bg-olive mobile-marginTop10 mobile-width"><i class="fa fa-money"></i> &nbsp; <?php echo t("Tax Rates")?></a>
        </div>
	    ...
	    <form method="post" action="<?php echo $view->action('save')?>">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="vivid-store-side-panel">
                        <ul>
                            ...
                            <li><a href="#settings-invoice" data-pane-toggle><?php echo t('Invoice')?></a></li>
                        </ul>
                    </div>
                </div>
                
                <div class="col-sm-8 store-pane active" id="settings-currency">
                ...
                <div class="col-sm-8 store-pane" id="settings-tax">
                ...
                <div class="col-sm-8 store-pane" id="settings-shipping">
                ...
                <div class="col-sm-8 store-pane" id="settings-payments">
                    <h3><?php echo t('Payment Timing');?></h3>
					
					<div class="row">
						<div class="col-xs-12 col-lg-2">
							<div class="form-group">
								<?php echo $form->label('paymentTimingDays',t('Days')); ?>
								<?php echo $form->text('paymentTimingDays',Config::get('vividstore.paymentTimingDays'));?>
							</div>
						</div>
						<div class="col-xs-12 col-lg-2">
							<div class="form-group">
								<?php echo $form->label('paymentTimingHours',t('Hours')); ?>
								<?php echo $form->text('paymentTimingHours',Config::get('vividstore.paymentTimingHours'));?>
							</div>
						</div>
						<div class="col-xs-12 col-lg-2">
							<div class="form-group">
								<?php echo $form->label('paymentTimingMinutes',t('Minutes')); ?>
								<?php echo $form->text('paymentTimingMinutes',Config::get('vividstore.paymentTimingMinutes')); ?>
							</div>
						</div>
						<div class="col-xs-12 col-lg-2">
							<div class="form-group">
								<?php echo $form->label('paymentTimingSeconds',t('Seconds')); ?>
								<?php echo $form->text('paymentTimingSeconds',Config::get('vividstore.paymentTimingSeconds')); ?>
							</div>
						</div>
					</div>
                    ...
                    <?php
                        if($installedPaymentMethods){
							...
							<?php if ($pm->getPaymentMethodHandle() == 'invoice' || $pm->getPaymentMethodHandle() == 'auth_net' || $pm->getPaymentMethodHandle() == 'paypal_standard') { ?>
							...
							<?php } ?>
                                ...
                                <div class="panel-body">
									<?php if ($pm->getPaymentMethodHandle() == 'bank_transfer') { ?>
                                    <div class="form-group paymentMethodEnabled" style="display:none;">
									<?php }else{ ?>
                ...
                <div class="col-sm-8 store-pane" id="settings-order-statuses">
                ...
                <div class="col-sm-8 store-pane" id="settings-notifications">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <?php echo $form->text('emailAlertName',Config::get('vividstore.emailalertsname')); ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- #settings-products -->
                <div class="col-sm-8 store-pane" id="settings-products">
                    <h3><?php echo t("Order Statuses")?></h3>
                    <div class="form-group">
                ...
                <!-- #settings-customers -->
                <div class="col-sm-8 store-pane" id="settings-checkout">
                ...
                <!-- #settings-invoice -->
                <div class="col-sm-8 store-pane" id="settings-invoice">
				
                    <h3><?php echo t('Invoice');?></h3>

                    <h4><?php echo t('From Address');?></h4>
					
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								<label for="address-company-name" class="control-label"><?php echo t("Company Name")?></label>
                                <?php echo $form->text('fromCompanyName',Config::get('vividstore.fromCompanyName')); ?>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label for="address-phone-number" class="control-label"><?php echo t("Registration No")?></label>
                                <?php echo $form->text('fromCompanyRegistrationNo',Config::get('vividstore.fromCompanyRegistrationNo')); ?>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group">
                                ...
                                <?php echo $form->text('fromCompanyFirstAddress',Config::get('vividstore.fromCompanyFirstAddress')); ?>
							</div>
						</div>
						<div class="col-sm-12">
							<div class="form-group">
								<label for="address-line-second" class="control-label"><?php echo t("Address Line 2")?></label>
                                <?php echo $form->text('fromCompanySecondAddress',Config::get('vividstore.fromCompanySecondAddress')); ?>
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<?php  echo $form->select('fromCompanyCountry', $billingCountries, Config::get('vividstore.fromCompanyCountry')); ?>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label for="address-city" class="control-label"><?php echo t("City")?> / <?php echo t("Town")?></label>
								<?php  echo $form->text('fromCompanyCity', Config::get('vividstore.fromCompanyCity')); ?>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label for="address-state" class="control-label"><?php echo t("State")?></label>
								<?php  echo $form->text('fromCompanyState', Config::get('vividstore.fromCompanyState')); ?>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label for="address-postal-code" class="control-label"><?php echo t("Postal Code")?></label>
								<?php  echo $form->text('fromCompanyPostal', Config::get('vividstore.fromCompanyPostal'), array("type"=>"number")); ?>
							</div>
						</div>
					</div>
    	    ...
    	    <div class="ccm-dashboard-form-actions-wrapper">
    	        <div class="ccm-dashboard-form-actions">
    	            <button class="pull-right btn btn-primary mobile-width" type="submit" ><?php echo t('Save Settings')?></button>
    	        </div>
    	    </div>
