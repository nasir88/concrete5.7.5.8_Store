...
<form method="post" id="update-group-form" class="form-stacked" action="<?php echo $view->url('/'.$_SESSION['myURLTheme'].'/users/groups/', 'update_group')?>" role="form">
	...
	deleteGroup = function() {
		if (confirm('<?php echo $delConfirmJS?>')) {
			location.href = "<?php echo $view->url('/'.$_SESSION['myURLTheme'].'/users/groups', 'delete', $group->getGroupID(), $valt->generate('delete_group_' . $group->getGroupID() ))?>";
		}
	}
	</script>
		...
		<div class="col-nsr-100 padLeftRight15">
			...
			<div id="NSR_Form">	
				...
				<div class="form-input">
					<input type="text" name="gName" id="gName" class="width80 mobile-width" value="<?php echo Loader::helper('text')->entities($group->getGroupName())?>" />
				</div>
			</div>
			...
			<div id="NSR_Form">	
				...
				<div class="form-input">
					<textarea name="gDescription" id="gDescription" rows="6" class="width80 mobile-width"><?php echo Loader::helper("text")->entities($group->getGroupDescription())?></textarea>
				</div>
			</div>
	...
	<div class="ccm-dashboard-form-actions-wrapper">
        <div class="ccm-dashboard-form-actions">
            ...
            <?php if ($group->getGroupID() != '1' && $group->getGroupID() != '2' && $group->getGroupID() != '3') { ?>
                <?php print $ih->button_js(t('Delete'), "deleteGroup()", 'right');?>
            <?php } ?>
        </div>
    </div>
</form>
...
<?php } else { ?>
	...
	<!--<div class="ccm-dashboard-header-buttons">
		<a href="<?php //echo View::url('/'.$_SESSION['myURLTheme'].'/users/add_group')?>" class="btn btn-primary"><?php //echo t("Add Group")?></a>
	</div>-->
	<?php //} ?>
