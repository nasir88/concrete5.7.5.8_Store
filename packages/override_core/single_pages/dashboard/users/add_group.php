...
<form method="post" id="add-group-form" action="<?php echo $view->url('/'.$_SESSION['myURLTheme'].'/users/add_group/', 'do_add')?>">
		...
		<div class="col-nsr-100 padLeftRight15">
			...
			<div id="NSR_Form">	
				...
				<div class="form-input">
					<input type="text" class="width80 mobile-width" name="gName" value="<?php echo Core::make('helper/text')->entities($_POST['gName'])?>" />
				</div>
			</div>
			...
			<div id="NSR_Form">	
				...
				<div class="form-input">
					<?php echo $form->textarea('gDescription', array('rows' => 6, 'class' =>'width80 mobile-width'))?>
				</div>
			</div>
...
<div class="ccm-dashboard-form-actions">
	...
	<button class="pull-right btn btn-primary" type="submit" ><i class="fa fa-save"></i> &nbsp; <?php echo t('Add Group')?></button>
</div>
</div>
