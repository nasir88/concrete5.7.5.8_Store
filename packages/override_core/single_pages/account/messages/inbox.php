...
<h1><?php echo t("Private Messages")?></h1>
    	...
    	<?php switch($this->controller->getTask()) {
    		...
    		case 'view_mailbox': ?>
                ...
                <a href="<?php echo URL::to('/'.$myURLAccount)?>" class="btn btn-default pull-right" /><?php echo t('Back to Account')?></a>
    		...
    		<?php
    			if (is_array($messages)) {
					...
					<tr>
						...
						<td class="ccm-profile-messages-item-name"><a href="<?php echo $view->url('/'.$myURLAccount.'/messages/inbox', 'view_message', $mailbox, $msg->getMessageID())?>"><?php echo $msg->getFormattedMessageSubject()?></a></td>
    		...
    		<a href="<?php echo $view->url('/'.$myURLAccount.'/messages/inbox', 'view_message', $box, $msgID)?>" class="btn btn-default"><?php echo t('Back to Message')?></a>
    		...
    		default:
                ...
                <div class="form-actions">
                    <a href="<?php echo URL::to('/'.$myURLAccount)?>" class="btn btn-default" /><?php echo t('Back to Account')?></a>
                </div>
