	...
	<div class="row">
		<div class="col-nsr-100 padLeftRight15">
			...
			<div class="input-group pull-right mobile-width mobile-pull-right">
				<a class="btn btn-success mobile-width" href="<?php echo View::url('/'.$_SESSION['myURLTheme'].'/users/add_group') ?>">
			...
			<div class="input-group width40 mobile-width pull-left mobile-pull-left mobile-marginTop10">
				<?php echo $form->search('keywords', $searchRequest['keywords'], array('placeholder' => t('Group Name')), array('class' => 'width400px'))?>
