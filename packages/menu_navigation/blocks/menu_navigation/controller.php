<?php
namespace Concrete\Package\MenuNavigation\Block\MenuNavigation;
...
/**
 * The controller for the MenuNavigation block.
 *
 * @package    Blocks
...
class Controller extends BlockController
{
    ...
    protected $btTable = 'btMenuNavigationNSR';
	...
	public function registerViewAssets($outputContent = '')
    {
		...
		if($bObj){
			...
			$blockURL = $uh->getBlockTypeAssetsURL($bt);
				...
				$this->addHeaderItem('<script type="text/javascript" src="'.$blockURL.'/assets/js/hoverIntent.js"></script>');
				$this->addHeaderItem('<script type="text/javascript" src="'.$blockURL.'/assets/js/superfish.js"></script>');
				$this->addHeaderItem('<script type="text/javascript" src="'.$blockURL.'/assets/js/superfish_options.js"></script>');
				$this->addHeaderItem('<script type="text/javascript" src="'.$blockURL.'/assets/js/megamenu.js"></script>');
				
				
				$this->addHeaderItem('<link rel="stylesheet" type="text/css" href="'.$blockURL.'/assets/css/superfish.css"/>');
				$this->addHeaderItem('<link rel="stylesheet" type="text/css" href="'.$blockURL.'/assets/css/megamenu.css"/>');
				$this->addHeaderItem('<link rel="stylesheet" type="text/css" href="'.$blockURL.'/assets/css/accordion_category.css"/>');
				//$this->addFooterItem('<script type="text/javascript" src="'.$blockURL.'/assets/xxx.js"></script>');
		}
    }
