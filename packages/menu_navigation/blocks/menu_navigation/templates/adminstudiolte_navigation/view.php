...
echo '<ul class="sidebar-menu">'; //opens the top-level menu
echo '<li class="header" style="text-transform:uppercase;">'.t('Dashboard').'</li>';
...
foreach ($navItems as $ni) {
    ...
    if ($ni->hasSubmenu) {
        echo '<ul class="treeview-menu">'; //opens a dropdown sub-menu
    } else {
