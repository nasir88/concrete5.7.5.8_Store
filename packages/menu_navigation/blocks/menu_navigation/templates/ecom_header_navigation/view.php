...
echo '<div id="single_menu">';		
echo '<ul class="sf-menu" id="sf-menu">'; //opens the top-level menu
	
	//if ($p->getCollectionName() === 'Home') {
	//	echo '<li class="nav-home nav-selected"><a href="' . DIR_REL . '" target="" class="nav-home nav-selected">' . t("Home") .'</a></li>';
	//} else {
	//	echo '<li class="nav-home"><a href="' . DIR_REL . '" target="" class="nav-home">' . t("Home") .'</a></li>';
	//}
