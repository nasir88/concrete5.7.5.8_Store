...
class Cart
{
    ...
    public static function getCart()
    {
        ...
        if (!isset(self::$cart)) {
            ...
            $code = $_SESSION['vividstore.code'];
			$codelength = count($code);
			//throw new Exception($codelength);
            if ($codelength > 0) {
			
				$code_separated = "'" . implode("','", $code) . "'";
                $rules = StoreDiscountRule::findDiscountRuleByCode($code_separated);
