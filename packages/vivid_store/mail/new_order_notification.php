                ...
                <tr>
                    <td width="50%" valign="top">
                        ...
                        <p>
                            ...
                            <?php echo $order->getAttribute("billing_address")->address1?><br>
                            <?php  if ($order->getAttribute("billing_address")->address2) {
                                echo $order->getAttribute("billing_address")->address2 . "<br>";
                            } ?>
                            <?php echo $order->getAttribute("billing_address")->city?>, <?php echo $order->getAttribute("billing_address")->state_province?> <?php echo $order->getAttribute("billing_address")->postal_code?><br><br>
                            <strong><?php echo t('Email')?></strong>: <a href="mailto:<?php echo $order->getAttribute("email"); ?>"><?php echo $order->getAttribute("email"); ?></a><br>
                            <strong><?php echo t('Phone')?></strong>: <?php echo $order->getAttribute("billing_phone")?><br>
                        </p>
                    </td>
                    <td valign="top">
                    <td>
