...
<div class="ccm-dashboard-header-buttons">
    ...
    ?>
    <a href="<?php echo URL::to('/dashboard/store/settings/shipping/clerk')?>" class="btn btn-info"><i class="fa fa-gift"></i> <?php echo t("Shipping Clerk")?></a>
    ...
    ?>
					<tr>
						...
						<td class="text-right">
                            ...
                            <a href="<?php echo URL::to('/dashboard/store/settings/shipping/toggle_status', $method->getShippingMethodID())?>" class="btn btn-default">
